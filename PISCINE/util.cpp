...
Permettre de logger en console les "saisies simul�es"
venant d'un fichier de test

Modifi� (mutil� !) par rapport au code original :
...
/// Couleur Windows par d�faut des saisies simul�es
...
/// Adapt� depuis https://stackoverflow.com/a/10151286
...
std::streambuf::int_type FILE_buffer::underflow()
{
    ...
    #endif // _WIN32
    /// Echo � la console des caract�res lus
...
{
    /// Erreur on ouvre simultan�ment 2 flots autoCin !
    if (previous_cinbuf)
